...
const useEvents = ({ topic }: UseEventsQuery) => {
    ...
    useEffect(() => {
        const handler = (comment) => {
            ...
            // This will cause the useComments hook to re-render the Comments component with fresh data
...
// ## Notes
// This hook subscribes to the smart contract's 'CommentsAdded' event
// And tells 'react-query' to make our useComments query as stale, causing it to re-fetch the list of comments
